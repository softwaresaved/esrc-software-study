...
### Fig 30: software used by % career stage
...
### Fig 32: important software by research discipline
...
important_software %>% left_join(data, by = "URN")                                  %>% 
                      ...
                      theme(axis.text.x = element_text(angle = -90, vjust = 0.15, hjust=0),
                            legend.position = "None") +
                      ylab("Research discipline") + xlab("Software used") -> Fig32

# Print the diagram to screen
print(Fig32)

# Save the diagram to file
suppressMessages(ggsave("Figures/Figure32.png", dpi = 360))
...
data %>% select(URN, Q6)             %>%
         ...
         geom_text(aes(label = paste0(n, " (", percent(n/N, accuracy = 1), ")")), vjust = -0.5, size = 4) -> Fig36

# Print the plot to screen
print(Fig36)

# Save the file to file
suppressMessages(ggsave("Figures/Figure36.png", dpi = 360))

```

### Fig 37: OS by % career stage
...
data %>% select(os = Q6, career = Q20)             %>%
         ...
         scale_fill_brewer(palette = "Set1", name = "Career stage") +
         theme(axis.text.x = element_text(size = 8), 
                             legend.text=element_text(size = 6))  -> Fig37

# Plot the graph to screen
print(Fig37)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure37.png", dpi = 360))
...
### Fig 38: OS by gender and career
...
data %>% select(os = Q6, career = Q20, gender = Q21)    %>%
         ...
         theme(axis.text.x = element_text(size = 8), 
                             legend.text=element_text(size = 6))  + 
         facet_wrap(~career) -> Fig38

# Print the plot to screen
print(Fig38)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure38.png", dpi = 360))
...
data %>% select(URN, starts_with("Q6_a"))         %>%
         ...
         theme_bw() + scale_fill_distiller(palette = "Blues", direction = 1) +         
         geom_text(aes(label = paste0(n, " (", percent(n/N, accuracy = 1),")")), vjust = -0.5, size = 3) +
...
suppressMessages(ggsave("Figures/Figure39.png", dpi = 360))
...
vc %>% mutate(xx = tt)                  %>% 
       ...
       theme_bw() + geom_tile(colour = "black") +
       scale_fill_distiller(palette = "Blues", direction = 1) +
       theme(axis.text.x = element_text(angle = -60, hjust = 0),
            legend.position = "None") +
       geom_text(aes(label = n), size = 4) +
       xlab("Use of OS") + ylab("Use of OS") -> Fig40

# Print the plot to screen
print(Fig40)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure40.png", dpi = 360))
...
### Fig 41: using OS by % career stage pop
...
data %>% select(starts_with("Q6_a"), career = Q20)   %>%
         ...
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig41

# Print the plot to screen
print(Fig41)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure41.png", dpi = 360))
```
...
### Fig 42: using OS by % gender and career
...
data %>% select(starts_with("Q6_a"), career = Q20, gender = Q21)   %>%
         ...
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) +
         xlab("Reasons for using Open Source") + ylab("Percentage") +
         scale_fill_brewer(palette = "Set2", name = "Gender") + facet_wrap(~career) -> Fig42

# Print the plot to screen
print(Fig42)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure42.png", dpi = 360))
...
data %>% select(URN, starts_with("Q6_b"))         %>%
         ...
         geom_col(colour = "black") + 
         theme_bw() + scale_fill_distiller(palette = "Blues", direction = 1) +
         geom_text(aes(label = paste0(n, " (",percent(n/N, accuracy = 0.1),")")), vjust = -0.5, size = 3) +
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0, size = 10), legend.position = "None") +
         xlab(my$lab) + ylab("Numbers") -> Fig43

# Print the plot to screen
print(Fig43)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure43.png", dpi = 360))
...
### Fig 45: responses by % career stage
...
data %>% select(starts_with("Q6_b"), career = Q20)  %>%
         ...
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig45

# Print the plot to screen
print(Fig45)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure45.png", dpi = 360))
...
### Fig 46: responses by % gender and career
...
data %>% select(starts_with("Q6_b"), career = Q20, gender = Q21) %>%
         ...
         xlab("Reasons for not using Open Source") + ylab("Percent") +
         scale_fill_brewer(palette = "Set2", name = "Gender") +
         facet_wrap(~ career) -> Fig46

# Print the plot to screen
print(Fig46)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure46.png", dpi = 360))
```


### Fig 44: contingency table
...
vc %>% mutate(xx = tt)                  %>% 
       ...
       theme(axis.text.x = element_text(angle = -60, hjust = 0),
            legend.position = "None") +
       geom_text(aes(label = n), size = 4) +
       xlab(lab) + ylab(lab) -> Fig44

# Print the plot to screen
print(Fig44)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure44.png", dpi = 360))
...
### Fig 33: how software is maintained
...
data %>% select(URN, num_range("Q7_", 1:7))             %>%
         ...
         geom_text(aes(label = paste0(n, " (", percent(n/N, accuracy = 1),")")), vjust = -0.5, size = 3) -> Fig33

# Print the plot to screen
print(Fig33)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure33.png", dpi = 360))
...
data %>% select(Q9)                                %>%
         ...
         geom_text(aes(label = paste0(n," (", per,")")), vjust = -0.5, size = 3) -> Fig47

# Print the plot to screen
print(Fig47)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure47.png", dpi = 360))
...
### Fig 48: responses by % career stage
...
data %>% select(Q9, career = Q20)                  %>%
         ...
         geom_text(aes(label = percent(per, accuracy = 1)),
                   position = position_dodge2(width = 0.9, preserve = "single"),  
                   vjust = -0.5, size = 3) +
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig48

# Print the plot to screen
print(Fig48)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure48.png", dpi = 360))
...
### Fig 49: responses by % gender and career
...
data %>% select(Q9, career = Q20, gender = Q21)    %>%
         ...
         geom_text(aes(label = percent(per, accuracy = 0.1)),
                   ...
                   vjust = -0.5, size = 3) +
         scale_fill_brewer(palette = "Set2", name = "Gender") +
         facet_wrap(~ career) -> Fig49

# Print the plot to screen
print(Fig49)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure49.png", dpi = 360))
...
data %>% select(URN, num_range("Q10_", 1:6))            %>%
         ...
         xlab(my$lab) + ylab("Numbers") +
         geom_text(aes(label = paste0(n, " (", percent(n/N, accuracy = 1),")")), vjust = -0.5, size = 3) +
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0), legend.position = "None") -> Fig50

# Print the plot to screen
print(Fig50)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure50.png", dpi = 360))
...
### Fig 51: sharing software contingency table
...
vc %>% mutate(xx = tt)                  %>% 
       ...
       theme(axis.text.x = element_text(angle = -60, hjust = 0),
            legend.position = "None") +
       geom_text(aes(label = n), size = 4) +
       xlab("Software sharing") + ylab("Software sharing") -> Fig51

# Print the plot to screen
print(Fig51)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure51.png", dpi = 360))
