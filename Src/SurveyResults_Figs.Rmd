...
# Save the plot to file
suppressMessages(ggsave("Figures/Figure64.png", dpi = 360))
```


#### Fig 65: responses as % of career stage
...
data %>% select(num_range("Q13_1_",1:5), career = Q20)                                  %>%
         ...
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig65

# Print the plot to screen
print(Fig65)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure65.png", dpi = 360))
...
# Save the plot to file
suppressMessages(ggsave("Figures/Figure66.png", dpi = 360))
```

#### Fig 67: responses as % of career stage
...
data %>% select(num_range("Q13_2_",1:5), career = Q20)                                  %>%
         ...
         geom_col(position = position_dodge2(width = 0.9, preserve = "single"), colour = "black") +
         geom_text(aes(y = per, label = percent(per, accuracy = 0.1)), 
                   position = position_dodge2(width = 0.9, preserve = "single"), size = 2.5, vjust = -0.5) +
         scale_y_continuous(labels = percent_format(accuracy = 1)) +
         theme_bw() + ylab("Percent") +
         xlab("Aware of how institution/funder's policies on how s/w is funded, managed and licensed") +
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig67

# Print the plot to screen
print(Fig67)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure67.png", dpi = 360))
```
...
data %>% select(URN, num_range("Q13_3_",1:5))           %>%
         ...
         geom_text(aes(label = paste0(n, " (", percent(n/N, accuracy = 1),")")), vjust = -0.5, size = 3) +
         theme_bw() + ylab("Numbers") + scale_fill_distiller(palette = "Blues", direction = 1) +
         xlab(my$lab) + theme(legend.position = "None") -> Fig68

# Print the plot to screen
print(Fig68)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure68.png", dpi = 360))

```

#### Fig 69: responses as % of career stage
...
data %>% select(num_range("Q13_3_",1:5), career = Q20)                                  %>%
         ...
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig69

# Print the plot to screen
print(Fig69)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure69.png", dpi = 360))
```
...
# Save the plot to file
suppressMessages(ggsave("Figures/Figure70.png", dpi = 360))

```


#### Fig 71: distribution of answers as % of career stage
...
data %>% select(num_range("Q13_4_",1:5), career = Q20)                                  %>%
         ...
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig71

# Print the plot to screen
print(Fig71)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure71.png", dpi = 360))
