...
### Fig 52: sharing software (modfied responses)
...
data %>% select(URN, num_range("Q10_", 1:5))         %>% 
         ...
         xlab(my$lab) + ylab("Numbers") +
         geom_text(aes(label = paste0(n, " (", percent(n/N, accuracy = 1),")")), vjust = -0.5, size = 3) +
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0), legend.position = "None") -> Fig52

# Print the plot to screen
print(Fig52)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure52.png", dpi = 360))
