...
### Fig 76: how skills are acquired
...
data %>% select(URN, num_range("Q11_", 1:12))            %>%
         ...
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0, size = 12), 
               legend.position = "None")  -> Fig76

# Print the plot to screen
print(Fig76)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure76.png", dpi = 360))

```


### Fig 78: contingency table
...
vc %>% mutate(xx = tt)                  %>% 
       ...
       theme(axis.text.x = element_text(angle = -60, hjust = 0),
            legend.position = "None") +
       geom_text(aes(label = n), size = 4) +
       xlab(lab) + ylab(lab) -> Fig78

# Print the plot to screen
print(Fig78)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure78.png", dpi = 360))


```

### Fig 77: skills acquisition by % career stage
...
data %>% select(num_range("Q11_", 1:12), career = Q20)   %>%
         ...
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0),
               legend.text=element_text(size = 8)) +
         scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig77

# Print the plot to screen
print(Fig77)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure77.png", dpi = 360))
...
### Fig 79: NCRM courses by career stage
...
data %>% select(URN, starts_with("Q11_b_"), career = Q20)      %>%
         ...
         xlab("Career stage") + 
         geom_text(aes(x = career, label = paste0(n," (",nid,")")), vjust = -0.5, size = 3)  -> Fig79

# Print the plot to screen
print(Fig79)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure79.png", dpi = 360))
...
### Fig 80: number of NCRM courses by individuals by career stage
...
data %>% select(URN, starts_with("Q11_b_"), career = Q20) %>%
         ...
         geom_text(aes(x = N, label = n), position = position_stack(0.5),  size = 4)  -> Fig80

# Print the plot to screen
print(Fig80)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure80.png", dpi = 360))
...
#### Fig 72: distribution percentages
...
data %>% select(URN, starts_with("Q13_"))                     %>%
        ...
        geom_text(aes(label = percent(p, accuracy = 0.1)), 
                  position = position_dodge2(width = 0.9), vjust = -0.5, size = 2.5)  -> Fig72

# Print the plot to screen
print(Fig72)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure72.png", dpi = 360))
...
### Fig 53: licensing policies awareness distributions
...
data %>% select(URN, starts_with("Q15_"), -"Q15_a")                     %>%
         ...
         ylab("Numbers") + xlab(my$lab)  +
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0, size = 10), 
               legend.position = "None")  -> Fig73

# Print the plot to screen
print(Fig73)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure73.png", dpi = 360))

```


### Fig 74: licensing policies awareness by % career stage
...
data %>% select(URN, starts_with("Q15_"), -"Q15_a", career = Q20)          %>%
         ...
         scale_y_continuous(labels = percent_format(accuracy = 1)) +
         geom_text(aes(label = per), vjust = -0.5,
                   position = position_dodge2(width = 0.9, preserve = "single"), size = 2.5) +
         ylab("Percent") + xlab("Aware of the policy for") +
         scale_fill_brewer(palette = "Set1", name = "Career stage") +
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) -> Fig74

# Print the plot to screen
print(Fig74)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure74.png", dpi = 360))


```


### Fig 75: awareness by gender and career stage
...
data %>% select(id = URN, starts_with("Q15_"), -"Q15_a", career = Q20, 
         ...
         scale_fill_brewer(palette = "Set2", name = "Gender") +
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) +
         facet_wrap(~career) -> Fig75

# Print the plot to screen
print(Fig75)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure75.png", dpi = 360))
