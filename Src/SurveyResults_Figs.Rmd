...
### Fig 54: sharing software by gender and career stage
...
data %>% select(sharesw, career = Q20, gender = Q21)                  %>%
         ...
         geom_col(position = position_dodge2(width = 0.9, preserve = "single"), colour = "black") +
         theme_bw() +
         scale_y_continuous(labels = percent_format(accuracy = 1), limits = c(0, 0.17)) +
         xlab("Who do you share your software with?") + ylab("Percent") +
         geom_text(aes(label = percent(n/N, accuracy = 0.1)), vjust = -0.5,
                   position = position_dodge2(width = 0.9, preserve = "single"),  size = 2) +
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) +
         scale_fill_brewer(palette = "Set2", name = "Gender") +
         facet_wrap(~career) -> Fig54

# Print the plot to screen
print(Fig54)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure54.png", dpi = 360))
...
data %>%  select(URN, rew = Q12)                   %>%
          ...
          geom_text(aes(label = paste0(n," (", per,")")), vjust = -0.5, size = 4) +
          theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust = 0, size = 10), 
                legend.position = "None") -> Fig55

# Print the plot to screen
print(Fig55)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure55.png", dpi = 360))


```


### Fig 56: recognition segmented by career stage percentage
...
data %>%  select(rew = Q12, career = Q20)       %>%
          ...
          geom_text(aes(label = percent(per, accuracy = 1)), 
                    ...
                    size = 3) +
          theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) +
          scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig56

# Print the plot to screen
print(Fig56)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure56.png", dpi = 360))
...
### Fig 57: distribution of where software is run
...
data %>%  select(URN, num_range("Q14_", 1:9))         %>%
          ...
          theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust = 0, size = 10), 
                legend.position = "None") -> Fig57

# Print the plot to screen
print(Fig57)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure57.png", dpi = 360))
...
### Fig 58: where software is run by % career stage
...
data %>%  select(num_range("Q14_", 1:9), career = Q20)         %>%
          ...
          geom_text(aes(label = per), vjust = -0.5,
                    position = position_dodge2(width = 0.9, preserve = "single"), size = 2) +
          theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) +
          scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig58

# Print the plot to screen
print(Fig58)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure58.png", dpi = 360))
...
data %>%  select(URN, num_range("Q16_", 1:13))            %>%
          ...
          theme_bw() + ylim(0, 91) +
          xlab(my$lab) + ylab("Numbers") + scale_fill_distiller(palette = "Blues", direction = 1) +
          geom_text(aes(label = paste0(n, " (", percent(n/N, accuracy = 1),")")),  vjust = -0.5, size = 2) +
          theme(axis.text.x = element_text(angle = -70, vjust = 0.5, hjust=0, size = 10),
                legend.position = "None") -> Fig59

# Print the plot to screen
print(Fig59)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure59.png", dpi = 360))
...
data %>%  select(num_range("Q16_", 1:13), career = Q20)         %>%
          ...
          geom_text(aes(label = percent(per, accuracy = 1)), 
                    position = position_dodge2(width = 0.9, preserve = "single"), vjust = -0.6, size = 2) +
          theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0, size = 10),
                legend.text = element_text(size = 8))  +
          scale_fill_brewer(palette = "Set1", name = "Career stage") -> Fig61

# Print the plot to screen
print(Fig61)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure61.png", dpi = 360))
...
### Fig 62: barriers as % of gender and career
...
data %>%  select(num_range("Q16_", 1:13), career = Q20, gender = Q21) %>%
          ...
          geom_col(position = position_dodge2(width = 0.9, preserve = "single"), colour = "black") +
          theme_bw() +
          scale_y_continuous(labels = percent_format(accuracy = 1), limits = c(0, 0.26)) +
          xlab("Barriers to software use") + ylab("Percentage") +
          geom_text(aes(label = percent(per, accuracy = 0.1)), 
                    position = position_dodge2(width = 0.9, preserve = "single"), vjust = -0.75, size = 1.5) +
          theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust = 0, size = 6))  +
          scale_fill_brewer(palette = "Set2", name = "Gender") +
          facet_wrap(~ career) -> Fig62

# Print the plot to screen
print(Fig62)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure62.png", dpi = 360))

```

### Fig 63: barriers and dissability
...
data %>%  select(num_range("Q16_", 1:13), dis = Q23)            %>%
          ...
          geom_col(position = position_dodge2(width = 0.9, preserve = "single"), 
                   colour = "black") +
          theme_bw() + scale_y_continuous(labels = percent_format(accuarcy = 1), limits = c(0, 0.7)) +
          xlab("Barriers to software use") + ylab("Percent") +
          geom_text(aes(y = n/N, label = per), 
                    position = position_dodge2(width = 0.9, preserve = "single"),
                    vjust = -0.5, size = 3) +
          theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust = 0, size = 10))  +
          scale_fill_brewer(palette = "Set3", name = "Dissability") -> Fig63

# Print the plot to screen
print(Fig63)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure63.png", dpi = 360))

```

### Fig 60: count combined choices
...
vc %>% mutate(blocks = tt)    %>% 
       ...
       theme(axis.text.x = element_text(angle = -60, hjust = 0),
            legend.position = "None") +
       geom_text(aes(label = n), size = 4) +
       xlab("Blockers") + ylab("Blockers") -> Fig60

# Print the plot to screen
print(Fig60)

# Save the plot to file
suppressMessages(ggsave("Figures/Figure60.png", dpi = 360))
```
