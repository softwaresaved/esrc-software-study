...
category. Taking this into account for each project, this gives a breakdown of the 
...
esrc_topics %>% select(category, AwardPounds, fracContrib)                      %>% 
                  ...
                  col.names = c("Category", "Number of awards","Number %", "Award (£)",
                                "Award %"))    
```
The order here is broadly similar to that produced by the research topics though there are some note-able
...
topics the order is the other way round.
