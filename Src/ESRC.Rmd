...
esrc_subjects %>% filter(category != "Other", category != "Uncategorised", Status == "Active")  %>% 
                  ...
                  ylab("Contribution") + xlab("Research subject") +
...
esrc_subjects %>% filter(category != "Other", category != "Uncategorised", Status == "Active")  %>% 
                  ...
                  scale_fill_viridis(option="magma") +
                  ylab("Total Awards (£)") + xlab("Research subject") +
                  theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 8), legend.position = "None")
```
...
esrc_subjects %>% filter(category != "Other", category != "Uncategorised", Status == "Active")  %>% 
                  ...
                  scale_y_continuous(labels = comma) +
                  scale_fill_viridis(option="magma") +
                  ylab("Average Awards (£)") + xlab("Research subject") +
                  theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 8), legend.position = "None")
```
...
This would be a zeroth order approximation to the matching with categries.
...
Like with research subjects a project might be assigned more than one research topic, 
as previously done if a project has been assigned with n topics then each will contribute 1/n to the 
classification count and will be assigned a contribution of Award_amount/n to each
...
esrc_topics %>% filter(category != "Other", category != "Uncategorised", Status == "Active")    %>% 
                  ...
                  geom_col(colour = "black") + theme_bw() +
                  scale_fill_viridis(option="magma") +
                  ylab("Contribution") + xlab("Category") +
                  theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 8), legend.position = "None")
```
...
esrc_topics %>% filter(category != "Other", category != "Uncategorised", Status == "Active")    %>% 
                  ...
                  scale_y_continuous(labels = comma) +
                  scale_fill_viridis(option="magma") +
                  ylab("Total Awards (£)") + xlab("Category") +
                  theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 8), legend.position = "None")
```
