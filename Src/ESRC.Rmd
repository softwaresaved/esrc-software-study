...
esrcdat %>% filter(Status == "Active")                                          %>% 
            ...
            ylab("Number of Awards") + xlab("Organisation") + scale_fill_viridis()
```
...
esrcdat %>% filter(Status == "Active")                                          %>% 
            ...
            theme_bw() + theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 6), legend.position = "None") +
            ylab("Total Awards (£)") + xlab("Organisation") + scale_fill_viridis(option="magma")
```
...
esrcdat %>% filter(Status == "Active")                                          %>% 
            ...
            geom_col(colour = "black") + scale_y_continuous(labels = comma) +
            theme_bw() + theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 6), legend.position = "None") +
            ylab("Average Award (£)") + xlab("Organisation") + scale_fill_viridis(option="inferno")
```
...
```
We can do a time line plot. From this we can see that certain organisations get different trenches of funding
before the original award has expired.
...
esrcdat %>% filter(Status == "Active")                                      %>%  
            ...
            theme_bw() + xlab("Duration") + ylab("Dep & Organisation") + 
