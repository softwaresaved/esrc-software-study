...
The expenditure of the awards over the whole time period by region ordered by the total award given:
...
We can generate the table for projects that are currently active ordered by the total award given:
...
esrcdat %>% select(LeadROName, AwardPounds)                                     %>% 
            ...
            mutate(AvgAward = TotalAward/Number)                                %>% 
...
### Active projects
This only shows the top 25 organisations with active projects by average value.
