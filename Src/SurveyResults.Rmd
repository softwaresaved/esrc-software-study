...
data %>%  select(career = Q20)     %>%
          ...
          theme_void() +
          geom_label_repel(aes(y = per, label = percent(per, accuracy = 1)), colour = "black",
                    position = position_stack(0.5), size = 2.5) +
          scale_fill_brewer(palette = "Set1", name = "Career stage")
```
...
Making the diagram a bit less busy by focusing on the non-White
component.
