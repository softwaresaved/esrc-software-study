...
data %>% select(num_range("Q2_b_",1:6), career = Q20)      %>%
         ...
         geom_text(aes(label = ..count..), position = position_stack(0.5), stat = "count", vjust = -0.35, size = 2)  +
         xlab("Data sources") + 
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) +
         scale_fill_brewer(palette = "Set1", name = "Career stage")
```
...
data %>% select(num_range("Q2_b_",1:6), career = Q20)      %>%
         ...
         geom_text(aes(label = scales::percent(per, accuracy = 1)), position = position_dodge(width = 0.9), vjust = -0.35, size = 2)  +
         xlab("Data sources") + 
         theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0)) +
         scale_fill_brewer(palette = "Set1", name = "Career stage")
```
...
data %>% select(dis = Q23, career = Q20)    %>% 
         ...
         geom_text(aes(x = dis, label = scales::percent(per, accuracy = 1)),
                   position = position_dodge(width = 0.9), colour = "black", size = 2, vjust = -0.5) +
         scale_fill_brewer(palette = "Set1", name = "Career stage")
```
