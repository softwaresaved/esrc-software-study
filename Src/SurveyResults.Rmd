...
In order to make the diagram less busy only institutions that have more than 2 
entries are shown.
...
For each multiple choice replace spaces by "-"s and collapse all the non-empty
choices and join them with an "_". So, if an individual only chose A then that
would only contribute an A, if an individual chose A, B and D then that would
contribute an A_B_D then we count all the combined choices. 
...
Only showing institutions that have more than 2 total entries to make the diagram
less busy.
...
choices and join them with an "_". So, if an individual only chose A then that
would only contribute an A, if an individual chose A, B and D then that would
contribute an A_B_D then we count all the combined choices. Only counting values
...
choices and join them with an "_". So, if an individual only chose A then that
would only contribute an A, if an individual chose A, B and D then that would
contribute an A_B_D then we count all the combined choices. Only showing 
combinations that have a count greater than 1.
...
choices and join them with an "_". So, if an individual only chose A then that
would only contribute an A, if an individual chose A, B and D then that would
contribute an A_B_D then we count all the combined choices. Only showing combinations
that have a count greater than 1.
