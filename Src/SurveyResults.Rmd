...
# Write this information back to the data tibble
data %>% select(URN, num_range("Q10_", 1:5))         %>% 
         pivot_longer(cols = num_range("Q10_", 1:5),
                      names_to = NULL,
                      values_to = "sharesw")         %>% 
...
```{r dveloping_importantsw_table_yes}
