...
data %>% select(num_range("Q3_", 1:7), career = "Q20")                     %>%
        ...
        scale_fill_brewer(palette = "Set1", name = "Career stage")
```
### Data sharing segmented by percentage responses at a career stage
...
### Software used segmented by career
...
### Most important software as a percentage by career stage
